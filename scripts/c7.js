...
var inputFirstname = document.querySelector('input#ime');
var inputLastname = document.querySelector('input#prezime');
var inputEmail = document.querySelector('input#prosek');
var inputAverage = document.querySelector('input#indeks');
